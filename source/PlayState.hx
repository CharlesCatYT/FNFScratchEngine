...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var toBuild:Array<StageObject> = stageData.stageBuild;

		switch (curStage)
		{
			default:
				for(object in toBuild) {
					var objectS:BGSprite = new BGSprite(object.name, object.anchorX, object.anchorY, object.scrollX, object.scrollY, object.animArray, object.shouldLoop);
					add(objectS)
				}
			case 'stage': //Week 1
